...
pub fn get_solver(puzzle: Puzzle) -> Option<Box<Solver>> {
    match puzzle.year {
        ...
        2016 => match puzzle.day {
            ...
            18 => solver!(2016, "18", puzzle.part),
            19 => solver!(2016, "19", puzzle.part),
            20 => solver!(2016, "20", puzzle.part),
            21 => solver!(2016, "21", puzzle.part),
            22 => solver!(2016, "22", puzzle.part),
            23 => solver!(2016, "23", puzzle.part),
            24 => solver!(2016, "24", puzzle.part),
            _ => None
        },
        _ => None
    }
